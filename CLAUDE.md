...
Vaani is a real-time bidirectional call translation app. This repo contains a Node.js backend and a Flutter app that together let two users on a call hear each other in their own language in real time.
...
app/
  auto_call_translate/ Flutter app
```
